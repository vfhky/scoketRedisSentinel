 ...
 * All rights reserved.
 *
 * The struct converted from http/https/tcp request data.
 */


#ifndef __SOCKET_REDIS_SENTINEL_CLIENT_REQ_INFO_H__
#define __SOCKET_REDIS_SENTINEL_CLIENT_REQ_INFO_H__
